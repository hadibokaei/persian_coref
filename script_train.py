...
model.train_phrase_identification(word_embedding, train_files_path[:5], train_files_path[:2], epoch_start=epoch_number, max_epoch_number=1000, learning_rate=0.00001)
