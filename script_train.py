...
model.train_pair_identification(word_embedding, train_files_path[:5], validation_files_path[:1], epoch_start=epoch_number, max_epoch_number=1000, learning_rate=0.0001)
