...
class CorefModel(object):
    ...
    def add_phrase_loss_train(self):
        self.phrase_identification_loss = tf.reduce_mean(- tf.math.multiply(self.candidate_phrase_probability,tf.math.log(self.gold_phrases)) \
                                          - tf.math.multiply(1-self.candidate_phrase_probability,tf.math.log(1-self.gold_phrases)))
