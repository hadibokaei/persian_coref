...
class CorefModel(object):
    ...
    def add_phrase_loss_train(self):
        self.phrase_identification_loss = tf.reduce_mean(- tf.math.multiply(self.candidate_phrase_probability,tf.math.log(tf.to_float(self.gold_phrases))) \
                                          - tf.math.multiply(1-self.candidate_phrase_probability,tf.math.log(1-tf.to_float(self.gold_phrases))))
        ...
        for epoch in range(epoch_start, max_epoch_number):
            for batch_number in range(len(all_docs_word_ids)):
                ...
                feed_dict = {
                    ...
                    self.gold_phrases: all_docs_gold_phrases[batch_number],
